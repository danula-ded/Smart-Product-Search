...
import { AppBadge, AppButton, AppCard, AppCardContent, AppCardHeader, EmptyState, SectionTitle } from '@/shared/ui'
  ...
  if (error || !product) {
    return (
      <EmptyState
        ...
        description={error ?? 'Попробуйте открыть страницу ещё раз.'}
        action={
          <AppButton variant="outline" onClick={() => navigate('/catalog')}>
            <ArrowLeft className="size-4" />
            Вернуться в каталог
