...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("px-3 py-2 text-xs font-semibold text-[var(--semantic-text-muted)]", className)}
      {...props}
    />
  )
}
